		...
		f.jsxs(f.Fragment, {
			children: [
				f.jsx("section", {
					id: "graphicsDesign",
					className:
						"bg-accent text-primary overflow-x-auto w-full h-auto portrait:lg:h-screen",
					children: f.jsxs("div", {
						className:
	...
	Jv = () =>
		f.jsx(f.Fragment, {
			children: f.jsx("section", {
				id: "videoEditing",
				className:
					"bg-gray text-primary overflow-x-auto w-full h-auto portrait:lg:h-screen",
				children: f.jsxs("div", {
					className:
						"w-full flex flex-col lg:flex-row items-center text-bg landscape:lg:~py-0/24 portrait:lg:my-[17.5rem]",
					children: [
						f.jsxs("div", {
							className:
								"left ~px-2/5 justify-start md:order-2 order-1 flex flex-col items-center lg:items-left w-full md:pb-10 lg:pb-0 h-full",
							children: [
								f.jsx("h4", {
									className:
						...
						f.jsx("div", {
							className:
								"right md:order-1 order-2 w-full flex items-center justify-end h-full portrait:lg:px-2",
							children: f.jsx("video", {
								className:
									"md:size-[50rem] portrait:lg:size-full w-full size-full",
		...
		f.jsxs(f.Fragment, {
			children: [
				...
				f.jsx("section", {
					...
					children: f.jsxs("div", {
						className:
							"flex items-center bg-accent landscape:gap-5 text-bg lg:flex-row flex-col text-center justify-center w-full h-auto h-full",
						children: [
							f.jsxs("div", {
								className:
		...
		f.jsxs(f.Fragment, {
			children: [
				...
				f.jsx("section", {
					...
					children: f.jsxs("div", {
						className:
							"flex flex-col lg:flex-row justify-between landscape:gap-5 items-center h-full w-full",
						children: [
							f.jsx("div", {
								className:
	...
	og = () =>
		f.jsx(f.Fragment, {
			children: f.jsx("section", {
				id: "CTA",
				className:
					"bg-primary text-primary overflow-x-auto w-full h-auto portrait:lg:h-screen",
				children: f.jsxs("div", {
					className:
						...
						f.jsx("div", {
							...
							children: f.jsxs("form", {
								...
								children: [
									...
									f.jsx("small", {
										className:
											"pt-4 text-center md:text-end md:pr-8 text-content",
