...
const EmailForm = () => {
	return (
		<>
			<section
				id='CTA'
				className='bg-primary text-primary overflow-x-auto w-full h-auto portrait:lg:h-screen'>
				<div className='flex flex-col items-center jusify-between mx-auto h-full w-full md:w-2/3 py-8 pt-24 px-4 md:px-0'>
					...
					<p className='w-full xl:px-10 pb-5 md:pb-0  text-center text-content px-2 ~text-base/xl xl:!leading-loose xl:mx-auto px-0 lg:py-5 lg:mx-0 '>
						...
						reach out. I'm always eager to explore new opportunities and discuss
						how I can contribute to your vision now
					</p>
					<div className='modal-body w-full lg:w-2/3 p-2 md:p-4 pt-0'>
						<form className='flex flex-col h-full py-2'>
							...
							<small className='pt-4 text-center md:text-end md:pr-8 text-content'>
								&copy;Charles Da - All Rights Reserved
							</small>
						</form>
					</div>
				</div>
